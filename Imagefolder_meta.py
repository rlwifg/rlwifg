...
class DatasetFolder(VisionDataset):
    ...
    def __init__(self, root_train, root_meta, loader, extensions=None, transform=None, target_transform=None, is_valid_file=None, cached=False, number=None):
        ...
        samples_train = make_dataset(self.root_train, class_to_idx_train, extensions, is_valid_file)

        classes_meta, class_to_idx_meta = self._find_classes(self.root_meta)
        samples_meta = make_dataset(self.root_meta, class_to_idx_meta, extensions, is_valid_file, number)
        ...
        if number != None:
            print('The validation set uses part of images, number of each class: ',number)
        else:
        ...
        print('number of validation images:',len(self.samples_meta))
    ...
    def __getitem__(self, index):
        ...
        if self.cached == False:
            ...
            sample_meta = self.loader(path_meta)
        else:
...
class Imagefolder_meta(DatasetFolder):
    ...
    def __init__(self, root_train, root_meta, transform=None, target_transform=None,
